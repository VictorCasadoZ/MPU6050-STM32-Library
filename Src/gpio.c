...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, USER_LED1_Pin|USER_LED2_Pin|OLED_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(FLASH__CS_GPIO_Port, FLASH__CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, OLED_DC_Pin|nRF_CE_Pin|nRF__CS_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = FLASH__CS_Pin|nRF__CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
